...
def newRestaurant():
    ...
    if request.method == 'POST':
        if form.validate():
            ...
            flash('please enter a valid menu name ')
        return redirect(url_for('showRestaurants'))
    else:
...
def newMenuItem(restaurant_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return """
        <script>function myFunction() {alert('You are not authorized to add
        menu items to this restaurant. Please create your own restaurant
